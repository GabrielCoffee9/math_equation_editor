...
class ExportJpegPage extends StatefulWidget {
  const ExportJpegPage({super.key, this.tex = ''});
  final String tex;

  @override
  State<ExportJpegPage> createState() => _ExportJpegPageState();
}

class _ExportJpegPageState extends State<ExportJpegPage> {
  String? tempTex;
